...
Open [http://localhost:8080/demo/](http://localhost:8080/demo/) in your browser.

Kinkeda loads automatically in the iframe. Use the **tune** icon to switch devices, adjust bar colors, or change the app URL.

## Notes

- Serve over HTTP — opening `demo/index.html` directly as a `file://` URL may block the iframe.
